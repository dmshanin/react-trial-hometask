...
/******/ 	__webpack_require__.p = "/react-trial-hometask/";
/******/
/******/
...
const SectionHeading = props => {
  ...
  }, props.number), _react.default.createElement("span", {
...
var _education = _interopRequireDefault(__webpack_require__(7));

var _SectionHeading = _interopRequireDefault(__webpack_require__(1));

var _Eduspace = _interopRequireDefault(__webpack_require__(6));
...
// Instruments
// Components
class Education extends _react.default.Component {
  render() {
    const eduspaceList = _education.default.map(eduspace => {
      return _react.default.createElement(_Eduspace.default, {
        degree: eduspace.degree,
        eduspace: eduspace.eduspace,
        key: eduspace.id,
        period: eduspace.period
      });
    });
    ...
    return _react.default.createElement("div", {
      ...
      number: "04.",
      title: "\u041E\u0431\u0440\u0430\u0437\u043E\u0432\u0430\u043D\u0438\u0435"
    }), eduspaceList, _react.default.createElement("span", {
      className: "copyright"
    }, "2018 \xA9 \u0418\u043B\u043E\u043D \u041C\u0430\u0441\u043A"));
  }
...
var _Contact = _interopRequireDefault(__webpack_require__(9));
...
// Instruments
// Components
class Contacts extends _react.default.Component {
  render() {
    const contactList = _contacts.default.map(contact => {
...
class Experience extends _react.default.Component {
  render() {
    const workplaceList = _experience.default.map(workplace => {
    ...
    return _react.default.createElement("section", null, _react.default.createElement(_SectionHeading.default, {
      number: "02.",
      title: "\u041E\u043F\u044B\u0442 \u0440\u0430\u0431\u043E\u0442\u044B"
    }), workplaceList);
  }
...
const Skill = props => {
  ...
  for (let i = 0; i < 10; i++) {
    ...
    points.push(_react.default.createElement("li", {
  ...
  return _react.default.createElement("div", {
    className: "skill"
  }, _react.default.createElement("span", null, props.title), _react.default.createElement("ul", null, points));
};
...
var _skillset = _interopRequireDefault(__webpack_require__(16));

var _SectionHeading = _interopRequireDefault(__webpack_require__(1));

var _Skill = _interopRequireDefault(__webpack_require__(15));
...
// Instruments
// Components
class Skillset extends _react.default.Component {
  render() {
    const skills = _skillset.default.map(skill => {
...
var _Experience = _interopRequireDefault(__webpack_require__(14));

var _Contacts = _interopRequireDefault(__webpack_require__(11));

var _Education = _interopRequireDefault(__webpack_require__(8));
...
module.exports = __webpack_require__.p + "images/elon-musk1.dcf9a.png";
...
var _elonMusk = _interopRequireDefault(__webpack_require__(19));
...
var _Content = _interopRequireDefault(__webpack_require__(18));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// Core
// Components
class Resume extends _react.default.Component {
  render() {
...
*/
var aa=__webpack_require__(4),ba=__webpack_require__(0),m=__webpack_require__(29),p=__webpack_require__(5),v=__webpack_require__(2),da=__webpack_require__(28),ea=__webpack_require__(27),fa=__webpack_require__(26),ha=__webpack_require__(3);
...
var _Resume = _interopRequireDefault(__webpack_require__(21));
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.7a960.js.map